    ...
    <div class="pad10">
        ...
        <el-form :inline="true" label-position="top" label-width="80px" ref="PersonFormData" :rules="rules" :model="PersonFormData">
            ...
            <el-form-item label="户号：">
                <el-input class="oinput" v-model="PersonFormData.householdNumber" placeholder="请输入户号"></el-input>
            </el-form-item>
            <el-form-item label="户主姓名：" prop="householder">
                <el-input class="oinput" v-model="PersonFormData.householder" placeholder="请输入户主姓名"></el-input>
            </el-form-item>
            <el-form-item label="户主关系：">
                <el-select class="oinput" @change="changeRelations" v-model="PersonFormData.relations" placeholder="请选择户主关系">
                    <el-option
            ...
            <el-form-item label="居住人姓名：" prop="personName" >
                <el-input class="oinput" v-model="PersonFormData.personName" placeholder="请输入居住人姓名"></el-input>
            </el-form-item>
            <el-form-item label="楼栋地址：" prop="buildingPlace" >
                <el-input class="oinput" v-model="PersonFormData.buildingPlace" placeholder="请输入楼栋地址"></el-input>
            </el-form-item>
            <el-form-item  label="房屋权属：">
                <el-select class="oinput" v-model="PersonFormData.houseOwnership" placeholder="请选择房屋权属">
                    <el-option
            ...
            <el-form-item label="户籍状况：">
                <el-select class="oinput" v-model="PersonFormData.registryConsistency" placeholder="请选择户籍状况 ">
                    <el-option
            ...
            <el-form-item label="性别：" prop="sex">
                <el-select class="oinput" v-model="PersonFormData.sex" placeholder="请选择性别 ">
                    <el-option
                    v-for="item in Sex"
                    :key="item.value"
                    :label="item.label"
            ...
            <el-form-item label="文化程度：" prop="qualifications">
                <el-select class="oinput" v-model="PersonFormData.qualifications" placeholder="请选择文化程度  ">
                    <el-option
            ...
            <el-form-item label="联系电话：" prop="contact">
                <el-input class="oinput" v-model="PersonFormData.contact" placeholder="请输入联系电话"></el-input>
            </el-form-item>
            <el-form-item label="政治面貌：">
                <el-select class="oinput" v-model="PersonFormData.politicalStatus" placeholder="请选择政治面貌">
                    <el-option
            ...
            <el-form-item label="民族：" prop="nation">
                <el-select class="oinput" v-model="PersonFormData.nation" placeholder="请选择民族 ">
                    <el-option
            ...
            <el-form-item label="公民身份证号：" prop="idCard">
                <el-input class="oinput" @blur="getBirth" v-model="PersonFormData.idCard" placeholder="请输入公民身份证号"></el-input>
            </el-form-item>
            <el-form-item label="出生日期：">
                <el-date-picker class="oinput" v-model="PersonFormData.birth" type="date" value-format="yyyy-MM-dd HH:mm:ss" placeholder="选择日期"></el-date-picker>
            </el-form-item>
            ...
            <el-form-item label="婚姻状况：" prop="maritalStatus">
                <el-select class="oinput" v-model="PersonFormData.maritalStatus" placeholder="请选择婚姻状况 ">
                    <el-option
                    v-for="item in GLOBAL.select.marry"
                    :key="item.value"
                    :label="item.label"
                    :value="item.value">
                    </el-option>
            ...
            <el-form-item label="籍贯：" prop="nativePlace" >
                <el-input class="oinput" v-model="PersonFormData.nativePlace" placeholder="请输入籍贯"></el-input>
            </el-form-item>
            
            <el-form-item label="职业现状：" prop="occupationStatus">
                <el-select class="oinput" v-model="PersonFormData.occupationStatus" placeholder="请选择职业现状 ">
                    <el-option
            ...
            <el-form-item label="工作单位：">
                <el-input class="oinput" v-model="PersonFormData.servicePlace" placeholder="请输入工作单位"></el-input>
            </el-form-item>
            <el-form-item label="特长：">
                <el-select class="oinput" v-model="PersonFormData.skills" placeholder="请选择特长 ">
                    <el-option
            ...
            <el-form-item label="暂住人数：">
                <el-input class="oinput" v-model="PersonFormData.populations" placeholder="请输入暂住人数"></el-input>
            </el-form-item>
...
export default {
    data(){
        ...
        return {
            ...
            category:this.GLOBAL.select.category,
            rules: {
                postUrl:[
                    { required: true, message: '请选择添加类别', trigger: 'change' }
                ],
                idCard: [
    ...
    methods:{
        ...
        postData(){
            ...
            var _this = this;
            this.$request.post('/zzHoseholdPopulation/insert',{...postObj},function(res){
                if(res.result == 1){
                    _this.$message('操作成功');
        ...
        reset(formName){
            for (const key in this.PersonFormData) {
                if (this.PersonFormData.hasOwnProperty(key)) {
                    this.PersonFormData[key] = '';
