    ...
    <div class="ocontent">
      ...
      <div>
        ...
        >
          ...
          <el-table-column prop="streetContact" label="街道责任人联系方式" show-overflow-tooltip></el-table-column>
          <el-table-column prop="communityPerson" label="社区责任人" show-overflow-tooltip></el-table-column>
          <el-table-column prop="communityContact" label="社区责任人联系方式" show-overflow-tooltip></el-table-column>
...
import editForm from "../../component/form/editformJiaoZheng.vue";
...
export default {
  ...
  methods: {
    ...
    getVal() {
      this.$request.get(
        "/zzHoseholdPopulationJiaozheng/listPage",
        {
